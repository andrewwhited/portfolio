...
<div class="container">
  <div class="row alpha">
    ...
    <div class="half column text">
      <h3>Chapter</h3>
      <p>I’m not in a position <em>to fret about</em> humanity’s condition, but <strong>I do</strong> sympathize with <a href="#">Calvino’s</a> desire to shed weight. Design has become very heavy to me the last few years. As I’ve pursued my practice, many of the field’s principles and expectations have become unwanted baggage that slow, fatigue, and sometimes worry me. To be clear: my belief that there are flaws in the mold of a designer does not suggest the mold is wrong, just that we may need more than one kind, simply because I find the mold really, really uncomfortable.</p>
    </div><!--End column -->
  </div><!--End Row ===============-->
  ...
  <div class="row pull">
    <div>
      <h4 class="quote">“I could put a really cool block quote here to make my point better and stuff like that. That’d be neat!”</h4>
      <h5><a href="">—Author of said quote</a></h5>
    </div><!--End column -->
  </div><!--End Row  ===============-->
  <div class="row">
    <div class="half column photo">
  ...
  <div class="row">
    ...
    <div class="half column text">
      <h3>Chapter</h3>
      <p>I’m not in a position to fret about humanity’s condition, but I do sympathize with <a href="">Calvino’s</a> desire to shed weight. Design has become very heavy to me the last few years. As I’ve pursued my practice, many of the field’s principles and expectations have become unwanted baggage that slow, fatigue, and sometimes worry me. To be clear: my belief that there are flaws in the mold of a designer does not suggest the mold is wrong, just that we may need more than one kind, simply because I find the mold really, really uncomfortable.</p>

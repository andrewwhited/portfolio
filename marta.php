...
<!-- Hero Section
–––––––––––––––––––––––––––––––––––––––––––––––––– -->
<div class="container scene_element slideright">
  <div class="row">
...
<div class="container">
  ...
  <div class="row pull">
    <div>
      <h4 class="quote">“The main goal of MARTA was mobility; mobility is man's fifth freedom. [The lack of mobility] imprisons people in their neighborhoods.”</h4>
  ...
  <div class="row alpha omega">
    <div class="half column text">
      ...
      <ul>
        <li>45% of rides</li>
        <li>Consistant everyday use</li>
        <li>Limited alteratives</li>
        <li>Riding into the city from suburbs</li>
      </ul>
      <h3>Students</h3>
      <ul>
        <li>31% of rides</li>
        <li>2-4 days a week</li>
        <li>Travel within downtown</li>
      </ul>
      <h3>Event Users</h3>
      <ul>
        <li>Infrequent and inconsistant ridership</li>
  ...
  <div class="row pull">
    <div>
      <h4>Mobility allows Atlantians to experience Atlanta to its fullest.</h4>
    </div><!--End column -->
  </div><!--End Row  ===============-->
  <div class="row">
    <div class="half column text">
      <h3>Typeface</h3>
      <p>One of the major problems I had when using MARTA was that the type was very illegible from distances and angles, so I wanted to address this first in my redesign. Marta’s current typeface does not meet the standards laid out in the ADA. I tested different typefaces legibility by hanging printouts at the end of our hall and getting classmates to try to read them. I found that Gotham preforms well from an accessibility standpoint and appropriately communicates the proposed MARTA brand.</p>
    </div><!--End column -->
    <div class="half column photo">
               <img 
...
<div class="row alpha">
  ...
  <div class="row">
    ...
    <div class="column photo">
            <img 
              srcset="images/marta/20XL.gif   4800w,
                      images/marta/20L.gif   1920w,
                      images/marta/20M.gif  1200w,
                      images/marta/20S.gif  600w"
              sizes="100vw"
              src="images/marta/20M.gif"
              alt="Wayfinding"/>
    </div><!--End Column-->
  </div><!--End Row  ===============-->
  ...
  <div class="row">
    <div class="column photo">
            <img 
              srcset="images/marta/18XL.gif   4800w,
                      images/marta/18L.gif   1920w,
                      images/marta/18M.gif  1200w,
                      images/marta/18S.gif  600w"
              sizes="100vw"
              src="images/marta/18M.gif"
              alt="Wayfinding"/>
    </div><!--End Column-->
  </div><!--End Row  ===============-->
  <div class="row">
    <div class="column photo">
            <img 
              srcset="images/marta/19XL.gif   4800w,
                      images/marta/19L.gif   1920w,
                      images/marta/19M.gif  1200w,
                      images/marta/19S.gif  600w"
              sizes="100vw"
              src="images/marta/19M.gif"
              alt="Wayfinding"/>
    </div><!--End Column-->
  </div><!--End Row  ===============-->
  <div class="row">
    ...
    <div class="column half photos">
            <img 
              srcset="images/marta/24XL.gif   4800w,
    ...
    <div class="column half photos">
        <img 
          srcset="images/marta/23XL.jpg   4800w,
    ...
    <div class="column photo">
            <img 
              srcset="images/marta/22XL.gif   4800w,
                      images/marta/22L.gif   1920w,
                      images/marta/22M.gif  1200w,
                      images/marta/22S.gif  600w"
              sizes="100vw"
              src="images/marta/22M.gif"
              alt="Map"/>
    </div><!--End Column-->
  </div><!--End Row  ===============-->
  <div class="row">
  ...
  <div class="half column photo">
             <img 
            srcset="images/marta/15XL.gif   3561w,
  ...
  <div class="row">
    <div class="column photo">
            <img 
              srcset="images/marta/14XL.gif   4494w,
                      images/marta/14L.gif   1920w,
                      images/marta/14M.gif  1200w,
                      images/marta/14S.gif  600w"
              sizes="100vw"
              src="images/marta/4M.gif"
              alt="Web"/>
    </div><!--End Column-->
  </div><!--End Row  ===============-->
  <div class="row">
    <div class="column photo">
            <img 
              srcset="images/marta/16XL.gif   4800w,
                      images/marta/16L.gif   1920w,
                      images/marta/16M.gif  1200w,
                      images/marta/16S.gif  600w"
              sizes="100vw"
              src="images/marta/16M.gif"
              alt="Mobile"/>
    </div><!--End Column-->
  </div><!--End Row  ===============-->
  <div class="row">
    <div class="column photo">
            <img 
              srcset="images/marta/17XL.gif   4800w,
                      images/marta/17L.gif   1920w,
                      images/marta/17M.gif  1200w,
                      images/marta/17S.gif  600w"
              sizes="100vw"
              src="images/marta/17M.gif"
              alt="Mobile"/>
    </div><!--End Column-->
  </div><!--End Row  ===============-->
    <div class="row">
